            ...
            <div className="row CFV h-100">
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 p-0 h-100 rightcnt">
                <div className="bg-white p-0">
                  <div className="d-flex justify-content-start pt-5 pl-5">
                    ...
                    <span className="cursorPointer d-inline-flex align-items-center CFV-en-text">
                      <span className="iconv1 iconv1-globe language-icon px-1" style={{ fontSize: '20px' }}></span>
                  ...
                  <div className="p-5">
                    <div className="d-flex flex-wrap justify-content-between">
                      <div className="w-100 pl-2">
                        ...
                        <h5 className="text-success font-weight-bold">{gender}</h5>
                        <h4 className="text-success font-weight-bold pb-5">{fingerScanStatus}</h4> */}
                        <h2 className="font-weight-bold CVF-Name">{userName}</h2>
                        <h5 className="text-body font-weight-bold">{gender}</h5>
                        {/* <h4 className="text-orange font-weight-bold pb-5 blinker-1">Fingerprint successfully</h4> */}
                        {/* <h4 className="text-danger font-weight-bold pb-5 blinker-1">Fingerprint successfully</h4> */}
                        <h4 className={fingerScanStatus === "Successfully Punched Fingerprint" ? "text-success font-weight-bold pb-5" : "text-danger font-weight-bold pb-5"}>{fingerScanStatus}</h4>
                      </div>
                      <div className="d-flex p-2 w-50 my-3 CFVW100sm">
                    ...
                    <div className="d-flex flex-wrap justify-content-between">
                      ...
                      <div className="d-flex p-2 w-100 mt-3 CFVW100sm">
                        <h3 className="text-danger iconv1 iconv1-biomatric-punch font-weight-bold mt-1"> </h3>
                        <div className="px-2">
                ...
                <div className="p-2 d-flex flex-wrap justify-content-between w-100 bg-primary jjjj">
                  ...
                  <div className="m-2">
                    ...
                    <h5 className="text-white font-weight-bold dirltrtar">{dateToDDMMYYYY(sortedPackage[0].endDate)}</h5>
                    {/* <h5 className="text-white font-weight-bold dirltrtar">22/01/2020</h5> */}
                  </div>
                </div>
              </div>
