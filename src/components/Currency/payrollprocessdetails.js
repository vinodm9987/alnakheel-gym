                ...
                <div className="row">
                    ...
                    <div className="container-fluid mt-3">
                        <div className="d-flex flex-wrap justify-content-between bgLightaqublue border rounded p-3 my-1">
                            ...
                            <div className="m-1">
                                <h6 className="text-muted m-0">Date of Join</h6>
                                <h5 className="font-weight-bold m-0">15/02/2020</h5>
                            </div>
                            <div className="m-1">
                                <h6 className="text-muted m-0">Job Type</h6>
                                <h5 className="font-weight-bold m-0">Full Time</h5>
                            </div>
                        </div>
                        ...
                        <div className="bgLightaqublue border rounded p-3 my-2">
                            ...
                            <div className="d-xl-flex flex-wrap justify-content-between">
                                <h5 className="font-weight-bold align-self-center">Employee Payslips</h5>
                                <div className="row">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <div className="form-group position-relative">
                                            <label htmlFor="Year" className="mx-sm-2 inlineFormLabel">Year</label>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><button type="button" className="badge-pill badge-warning mx-1 px-4 text-white border-0 py-1" data-toggle="modal" data-target="#PayslipModalprpd">View</button>
                                                <button type="button" className="badge-pill badge-primary mx-1 px-4 text-white border-0 py-1">Download</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            <div className="container">
                                                <div className="text-center my-3">
                                                    <img src="/static/media/gymnago.8cf7122d.png" className="" width="250" />
                                                </div>
                                                <div className="d-flex flex-wrap justify-content-between py-3">
                                                    <div className="">
                                                        <div className="mb-1">
                                                            <label className="m-0 font-weight-bold">Employee Name:</label>
                                                            <span className="mx-2">Mohammed Al Mulla</span>
                                                        </div>
                                                        <div className="mb-1">
                                                            <label className="m-0 font-weight-bold">Designation:</label>
                                                            <span className="mx-2">IT Manager</span>
                                                        </div>
                                                        <div class="mb-1">
                                                            <label class="m-0 font-weight-bold">Monthly:
                                                            <span class="mx-2">July</span></label>
                                                            <label class="m-0 font-weight-bold ml-sm-2">Year:
                                                            <span class="mx-2">2020</span></label>
                                                        </div>
                                                    </div>
                                                    <div className="">
                                                        <div className="text-md-right">
                                                            <label className="m-0 font-weight-bold">Date:</label>
                                                ...
                                                <h6 className="text-muted">In Words: <span className="mx-1">Twenty six Thousand Egit Hundered</span></h6>
                                                <div className="d-flex flex-wrap justify-content-between">
                                                    <div className="py-3">
                                                        <div className="mb-1">
                                                            <label className="m-0 font-weight-bold text-muted">Ref No:</label>
                                                            <span className="mx-2">Bank NEFT</span>
                                                        </div>
                                                        <div className="mb-1">
                                                            <label className="m-0 font-weight-bold text-muted">Payment Transfer Date:</label>
                                                            <span className="mx-2">15/05/2020</span>
                                                        </div>
                                                    </div>
                                                    <div className="py-3">
                                                        <div className="text-md-right">
                                                            <label className="m-0 font-weight-bold text-muted">Name Of Bank:</label>
                                                ...
                                                <div className="d-flex flex-wrap justify-content-between">
                                                    <div className="py-3">
                                                        <h6 className="m-0 text-muted font-weight-bold">Signature of Employee</h6>
                                                        <h6 className="m-0 mt-1">trisha</h6>
                                                    </div>
                                                    <div className="py-3">
                                                        <div className="text-md-right">
                                                            <label className="m-0 font-weight-bold text-muted">Director:</label>
                                                            <span className="mx-2">*************</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="text-right">
                                                    <button type="button" class="btn btn-success px-4 py-1 my-2">Print</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
