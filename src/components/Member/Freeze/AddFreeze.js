          ...
          <div className="PageBillWrapper d-none">
            <div style={{ width: "450px", padding: "15px", margin: "auto" }} id="newPrint">
              <div style={{ display: "flex", justifyContent: "center" }}>
                <img src={packageReceipt.memberId.branch.avatar ? `/${packageReceipt.memberId.branch.avatar.path}` : ''} width="200" style={{ width: "100px" }} alt="" />
              </div>
              ...
              <p style={{ textAlign: "center", margin: "0 0 10px 0" }}>{t('VAT')} - {packageReceipt.memberId.branch.vatRegNo}</p>
              ...
              <p style={{ textAlign: "center", margin: "0" }}>
                <span style={{ padding: "0 2px" }}>{packageReceipt.memberId.memberId}</span>
                <span style={{ padding: "0 2px" }}>{packageReceipt.memberId.credentialId.userName}</span>
                <span style={{ padding: "0 2px" }}>{packageReceipt.memberId.mobileNo}</span>
              </p>
              <div>
