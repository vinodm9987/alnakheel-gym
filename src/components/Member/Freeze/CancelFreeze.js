                        ...
                        <table className="borderRoundSeperateTable tdGray">
                            ...
                            <tbody>
                                {freezeHistory && getPageWiseData(this.state.pageNumber, freezeHistory, this.state.displayNum).map((freeze, i) => {
                                    const { fromDate, toDate, reactivationDate, memberId: { _id: member, credentialId: { userName, avatar }, memberId }, reason, noOfDays, returningDate, typeOfFreeze, check, _id } = freeze
                                    return (
                                        <tr key={i}>
                                            <td>
                                                <div className="d-flex w-100">
                                                                    ...
                                                                    <div className="form-group position-relative">
                                                                        ...
                                                                        <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(e) => this.setState(validator(e, 'date', 'returningDate', []))}
                                                                            />
                                                                        </MuiPickersUtilsProvider>
                                                                        <span className="iconv1 iconv1-calander dateBoxIcon"></span>
                                                                    </div>
