...
class MyClassDetails extends Component {
  ...
  render() {
    ...
    if (this.props.classById) {
      ...
      const { className, description, branch: { branchName }, room: { roomName }, capacity, startTime, members,
        endTime, startDate, endDate, classDays, occupied } = this.props.classById
      ...
      return (
        <div className="mainPage p-3 MyClassDetails">
          <div className="row">
              ...
              <div className="bg-light mt-4 p-4">
                ...
                <div className="d-flex flex-wrap justify-content-lg-between">
                  <div className="d-flex m-2">
                    <span className="iconv1 iconv1-location mr-1 h1 m-0 text-warning"></span>
                    <div className="mx-2 whiteSpaceNoWrap"><h6 className="m-0">{t('Branch')}</h6>
                      <span className="font-weight-bold">{branchName}</span>
                    </div>
                  </div>
                  <div className="d-flex m-2">
                    <span className="iconv1 iconv1-clock mr-2 text-warning h1 m-0"></span>
                  ...
                  <div className="d-flex m-2">
                    <span className="iconv1 iconv1-calendar mr-2 text-warning h1 m-0"></span>
                  ...
                  <div className="d-flex m-2">
                    <span className="iconv1 iconv1-room mr-1 text-warning h1 m-0"></span>
                ...
                <div className="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 my-3">
                  <div className="form-group inlineFormGroup">
                    <label htmlFor="Days" className="mx-sm-2 inlineFormLabel">{t('Days')}</label>
...
export default withTranslation()(connect(mapStateToProps)(MyClassDetails))